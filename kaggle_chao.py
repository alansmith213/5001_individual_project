...
# read files and save them to train and test dataset
train = pd.read_csv('../5001/train.csv')
test = pd.read_csv('../5001/test.csv')

# transfer penalty_code from string variable to float
